...
import './footer.css'
import {webAddress, phoneNum, email, fbAddress, twitterAddress, linkedInAddress} from '../../data/constants'
      ...
      <div className = 'footer-bar'>
        <div className = 'footer-text'>
          <div className = 'footer-link-cont'>
            <a href={webAddress} className = 'footer-item footer-link'> {webAddress} </a>
          </div>
          <div className = 'footer-link-cont'>
            <a href={phoneNum} className = 'footer-item footer-link'> {phoneNum} </a>
          </div>
          <div className = 'footer-link-cont'>
